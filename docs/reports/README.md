...
`EXPERTS_PAIRING_FIELDS` refuses to pair two arms that ran different arithmetic. What the pin costs
is the fast path — which is precisely the P8 kernel’s job, and the
