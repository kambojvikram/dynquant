...
Still not claimed: no timing for the grouped kernel, no vectorized variant, one architecture,
and `compute-sanitizer` has not been re-run on a build that contains it.
