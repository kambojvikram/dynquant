...
# Importing this also gates the file on transformers, which nothing here names: every
# path that drives the stub reaches `greedy_generation_config`. See its docstring.
